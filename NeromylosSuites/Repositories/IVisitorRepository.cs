...
namespace NeromylosSuites.Repositories
{
    ...
    {
        Task<Visitor?> GetVisitorByLastnameAsync(string lastname);
        ...
        Task<PaginatedResult<Visitor>> GetPaginatedVisitorsFilteredAsync(int pageNumber, int pageSize, List<Expression<Func<Visitor, bool>>> predicates);
    }
}
